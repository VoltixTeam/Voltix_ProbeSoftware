#ifndef VOLTIXPROBE_CONFIG_H_
#define VOLTIXPROBE_CONFIG_H_
...
/* Controls switch that bypasses power supply of Voltix module for current
 * measurements.*/
